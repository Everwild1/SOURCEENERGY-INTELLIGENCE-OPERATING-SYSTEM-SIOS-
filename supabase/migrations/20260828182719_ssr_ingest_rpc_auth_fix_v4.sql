...
begin
  ...
  return jsonb_build_object('batch_id',v_batch_id,'anchor_tile_id',v_anchor_tile_id,'ssr_level',v_ssr_level,'w3w_address',v_w3w_address,'latitude',v_latitude,'longitude',v_longitude);
end;
$$;
